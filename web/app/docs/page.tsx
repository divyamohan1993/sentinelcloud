...
# open http://localhost:8080`}</code></pre>
          ...
          <article className="glass p-5">
            ...
            <pre className="code text-[12.5px]"><code>{`gcloud config set project dmjone
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-[13.5px]">
            ...
            <tbody className="divide-y divide-[var(--color-line)]">
              <tr><td className="py-2.5 pr-4 font-mono text-[var(--color-accent)]">GOOGLE_CLOUD_PROJECT</td><td className="py-2.5 pr-4 font-mono">dmjone</td><td className="py-2.5 pr-4">Project for Vertex AI and Firestore.</td></tr>
              ...
              <tr><td className="py-2.5 pr-4 font-mono text-[var(--color-accent)]">SENTINEL_ADMIN_EMAILS</td><td className="py-2.5 pr-4 font-mono">divyamohan1993@gmail.com</td><td className="py-2.5 pr-4">Comma-separated allowlist for connector-mode actions.</td></tr>
            </tbody>
          </table>
        </div>
      </Section>
